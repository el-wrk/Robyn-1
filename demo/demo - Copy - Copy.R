...
################################################################
#### Step 1: load data
set_country <- "GB" # Including national holidays for 59 countries, whose list can be found on our github guide 
...
add <- "_ORDERS_ATTRIBUTION" # _ + sales leads orders reprise 
...
InputCollect <- robyn_inputs(
  ...
  ,context_vars = c("qr_o", "ford_domain_o") # typically competitors, price & promotion, temperature, unemployment rate etc
  ,context_signs = c("default", "default") # c("default", " positive", and "negative"),
  ,paid_media_vars = c("p_search_o", "direct_o"	,	"social_o"	,"display_o" , "email_o", "referrer_o") # we recommend to use media exposure metrics like impressions, GRP etc for the model. If not applicable, use spend instead
  ,paid_media_signs = c("positive", "positive", "positive", "positive", "positive", "positive") # c("default", "positive", and "negative")
  ,paid_media_spends = c("p_search_o", "direct_o"	,	"social_o"	,"display_o" , "email_o", "referrer_o") # Controls the signs of coefficients for media variables
  ,organic_vars = c("n_search_o", "internal_o")
...
hyperparameters <- list(
  ...
  direct_o_alphas = c(0.5, 3)
  ,direct_o_gammas = c(0.3, 1)
  ,direct_o_shapes = c(0.0001, 2)
  ,direct_o_scales = c(0, 0.1)
  
  ,display_o_alphas = c(0.5, 3)
  ,display_o_gammas = c(0.3, 1)
  ,display_o_shapes = c(0.0001, 2)
  ,display_o_scales = c(0, 0.1)
  
  ,email_o_alphas = c(0.5, 3)
  ,email_o_gammas = c(0.3, 1)
  ,email_o_shapes = c(0.0001, 2)
  ,email_o_scales = c(0, 0.1)
  
  ,internal_o_alphas = c(0.5, 3)
  ,internal_o_gammas = c(0.3, 1)
  ,internal_o_shapes = c(0.0001, 2)
  ,internal_o_scales = c(0, 0.1)
  ...
  ,referrer_o_alphas = c(0.5, 3)
  ,referrer_o_gammas = c(0.3, 1)
  ,referrer_o_shapes = c(0.0001, 2)
  ,referrer_o_scales = c(0, 0.1)
  
  ,social_o_alphas = c(0.5, 3)
  ,social_o_gammas = c(0.3, 1)
  ,social_o_shapes = c(0.0001, 2)
  ,social_o_scales = c(0, 0.1)
  
  ,n_search_o_alphas = c(0.5, 3)
  ,n_search_o_gammas = c(0.3, 1)
  ,n_search_o_shapes = c(0.0001, 2)
  ,n_search_o_scales = c(0, 0.1)

  ,p_search_o_alphas = c(0.5, 3)
  ,p_search_o_gammas = c(0.3, 1)
  ,p_search_o_shapes = c(0.0001, 2)
  ,p_search_o_scales = c(0, 0.1)
...
select_model <- "1_315_1" # select one from above
