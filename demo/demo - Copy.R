...
add <- "_LEADS_ATTRIBUTION" # _ + sales leads orders reprise 
...
InputCollect <- robyn_inputs(
  ...
  ,context_vars = c("qr_l", "ford_domain_l") # typically competitors, price & promotion, temperature, unemployment rate etc
  ,context_signs = c("default", "default") # c("default", " positive", and "negative"),
  ,paid_media_vars = c("p_search_l", "direct_l"	,	"social_l"	,"display_l" , "email_l", "referrer_l") # we recommend to use media exposure metrics like impressions, GRP etc for the model. If not applicable, use spend instead
  ,paid_media_signs = c("positive", "positive", "positive", "positive", "positive", "positive") # c("default", "positive", and "negative")
  ,paid_media_spends = c("p_search_l", "direct_l"	,	"social_l"	,"display_l" , "email_l", "referrer_l") # Controls the signs of coefficients for media variables
  ,organic_vars = c("n_search_l", "internal_l")
...
hyperparameters <- list(
  ...
  direct_l_alphas = c(0.5, 3)
  ,direct_l_gammas = c(0.3, 1)
  ,direct_l_shapes = c(0.0001, 2)
  ,direct_l_scales = c(0, 0.1)
  
  ,display_l_alphas = c(0.5, 3)
  ,display_l_gammas = c(0.3, 1)
  ,display_l_shapes = c(0.0001, 2)
  ,display_l_scales = c(0, 0.1)
  
  ,email_l_alphas = c(0.5, 3)
  ,email_l_gammas = c(0.3, 1)
  ,email_l_shapes = c(0.0001, 2)
  ,email_l_scales = c(0, 0.1)
  
  ,internal_l_alphas = c(0.5, 3)
  ,internal_l_gammas = c(0.3, 1)
  ,internal_l_shapes = c(0.0001, 2)
  ,internal_l_scales = c(0, 0.1)
  ...
  ,referrer_l_alphas = c(0.5, 3)
  ,referrer_l_gammas = c(0.3, 1)
  ,referrer_l_shapes = c(0.0001, 2)
  ,referrer_l_scales = c(0, 0.1)
  
  ,social_l_alphas = c(0.5, 3)
  ,social_l_gammas = c(0.3, 1)
  ,social_l_shapes = c(0.0001, 2)
  ,social_l_scales = c(0, 0.1)
  
  ,n_search_l_alphas = c(0.5, 3)
  ,n_search_l_gammas = c(0.3, 1)
  ,n_search_l_shapes = c(0.0001, 2)
  ,n_search_l_scales = c(0, 0.1)

  ,p_search_l_alphas = c(0.5, 3)
  ,p_search_l_gammas = c(0.3, 1)
  ,p_search_l_shapes = c(0.0001, 2)
  ,p_search_l_scales = c(0, 0.1)
...
select_model <- "2_254_1" # select one from above
